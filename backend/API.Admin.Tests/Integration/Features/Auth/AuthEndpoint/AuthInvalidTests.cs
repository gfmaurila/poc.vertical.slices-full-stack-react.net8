...
public class AuthInvalidTests : IClassFixture<UseSqliteWebApplicationFactory<Program>>
{
    private readonly HttpClient _client;
    private readonly UseSqliteWebApplicationFactory<Program> _factory;

    public AuthInvalidTests(UseSqliteWebApplicationFactory<Program> factory)
    {
        _factory = factory;
